...
@interface ShadesOfGreyModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation ShadesOfGreyModelController
...
{   
    ...
    ShadesOfGreyDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"ShadesOfGreyDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(ShadesOfGreyDataViewController *)viewController];
